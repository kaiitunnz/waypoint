...
WAYPOINT_HOST="${WAYPOINT_HOST:-127.0.0.1}"
WAYPOINT_PORT="${WAYPOINT_PORT:-8787}"
WAYPOINT_PASSWORD="${WAYPOINT_PASSWORD:-change-me}"
...
sed \
  ...
  -e "s|{{WAYPOINT_PASSWORD}}|${WAYPOINT_PASSWORD}|g" \
  -e "s|{{WAYPOINT_HOST}}|${WAYPOINT_HOST}|g" \
  -e "s|{{WAYPOINT_PORT}}|${WAYPOINT_PORT}|g" \
