...
DEFAULT_SKILLS=("waypoint" "waypoint-subagents" "waypoint-comms" "waypoint-workqueue" "waypoint-crew" "waypoint-manager" "waypoint-worktree" "waypoint-research")
...
Defaults:
  skills        waypoint waypoint-subagents waypoint-comms waypoint-workqueue waypoint-crew waypoint-manager waypoint-worktree waypoint-research
