...
- [ ] **Auto-complete for built-in commands.** The frontend should support auto-complete for built-in slash commands.
- [ ] **Support session pagination and pinning.** Support session pagination and pinning to top. Default sessions per page should be set carefully.
