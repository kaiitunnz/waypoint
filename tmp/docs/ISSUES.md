...
- [ ] **Phone notch eats into the page content.** On the web-app mode, the phone notch eats into the page content.
- [ ] **Auto-scroll is janky.** Sometimes auto-scroll does not work or does not go all the way to the bottom.
- [ ] **Frequent need to relogin.** I frequently need to relogin. Not sure why.
- [ ] **Approval on top.** The command approval panel should appear at the bottom near the chatbox instead of at the top of the page.
- [ ] **The session schedule list should be clearable.** Currently I cannot clear the session schedule list. Is there any timeout mechanism? Will the schedules be there indefinitely?
